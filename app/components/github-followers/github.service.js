        ...
        execute: function() {
            GithubService = (function () {
                ...
                GithubService.prototype.getUser = function (userName) {
                    return this._http.get(this._baseUrl + userName).map(function (response) { return response.json(); });
                };
                GithubService.prototype.getFollowers = function (userName) {
                    return this._http.get(this._baseUrl + userName + '/followers').map(function (response) { return response.json(); });
                };
